    ...
    <div class="col-sm-12">
        <div class="" style="padding-left:5px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Vuelo Operaci&oacuten</li>
            </ol>
        </div>
    </div>
</div>
<div class="row" style="margin-top:15px;">
    ...
    <div class="col-sm-12" style="padding:10px 20px 0px 20px;">
        <div class="section">DATOS DE VUELO</div>
    </div>
    <form action='{{route("operacion.vueloSave")}}' method="POST" id="form"  class="row" style="margin: 0px;">
                @method("POST")
                @csrf
...
<script src="{{ URL::asset('js/operaciones/vuelo.js'); }}"></script>    
