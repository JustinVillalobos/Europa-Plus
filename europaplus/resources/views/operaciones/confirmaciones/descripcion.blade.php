  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body" style="overflow-y: auto;overflow-x: auto;">
        <div class="row">
                <div class="col-sm-12">
                    @include("../operaciones/confirmaciones/mails/descripcion")
                </div>
        </div>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary btn-modal" data-dismiss="modal" style="margin-left:5px;"  onclick="print(true)"><i class="fa fa-save"></i> Imprimir</button>
...
<script src="{{ URL::asset('js/operaciones/modales/descripcion.js'); }}"></script>  
