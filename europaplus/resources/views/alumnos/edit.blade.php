            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-12 form-inline text-end">
                        ...
                        <input type="text" class="form-control" style="width:66%;" id="nombre" value="{{$alumno->alu_nombre}}"/>
                ...
                <div class="row" style="margin-top:5px;">
                    <div class="col-sm-12 form-inline text-end">
                        ...
                        <input type="date" class="form-control" style="width:45%;" id="fecha_nacim" value="<?php echo $temp[2]."-".$temp[1]."-".trim($temp[0]) ?>"/>
                ...
                <div class="row" style="margin-top:5px;">
                    <div class="col-sm-12 form-inline text-end">
                        ...
                        <input type="text" class="form-control" style="width:66%;" id="correo" value="{{$alumno->alu_email}}"/>
                        <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-12 form-inline text-end">
                        ...
                        <input type="text" class="form-control" style="width:66%;" id="apellidos" value="{{$alumno->alu_apellidos}}"/>
                        <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
                    </div>
                </div>
                <div class="row" style="margin-top:5px;">
                    <div class="col-sm-12 form-inline text-end">
                        ...
                        <Select type="text" class="form-select " style="width:66%;" id="sexo" value="{{$alumno->alu_sexo}}">
                ...
                <div class="row" style="margin-top:5px;">
                    <div class="col-sm-12 form-inline text-end">
                        ...
                        <input type="text" class="form-control" style="width:30%;" id="pasaporte" value="{{$alumno->alu_dni}}"/>
                        <label class="font-weight-bold" style="width:13%;justify-content: end; margin-right: 5px;">Cáduca:</label>
                        <input type="date" class="form-control" style="width:27%;" id="caduca" value="<?php echo $tempExp[2]."-".$tempExp[1]."-".trim($tempExp[0]) ?>"/>
                        <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">País:</label>
                 <Select type="text" class="form-select" style="width:67%;" id="paises" value="{{$alumno->pais_id}}">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Provincia:</label>
                 <Select type="text" class="form-select" style="width:67%;" id="provincias" value="{{$alumno->prv_id}}">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Localidad:</label>
                 <Select type="text" class="form-select" style="width:67%;" id="localidades" value="{{$alumno->loc_id}}">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">C. Postal:</label>
                 <input type="text" class="form-control" style="width:67%;" id="cPostal" value="{{$alumno->alu_cp}}">
                 <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
             </div>
        </div>
        <div class="row">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Idioma:</label>
                 <Select type="text" class="form-select" style="width:67%;" id="idiomas" value="{{$alumno->idi_id}}">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Nivel Idioma:</label>
                 <Select type="text" class="form-select" style="width:67%;" id="nivel_idioma" value="{{$alumno->alu_nivel_idioma}}">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="text-danger font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Medio Contacto:</label>
                 <Select type="text" class="form-select" style="width:67%;" id="medioContacto" value="{{$alumno->alu_medio_contacto}}">
                    @foreach($medios as $m)
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Alergías:</label>
                 <input type="text" class="form-control" style="width:67%;" id="alergias" value="{{$alumno->alu_alergias}}">
                 <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
             </div>
        </div>
    </div>
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-sm-12 form-inline text-end">
                <label class="font-weight-bold" style="width:30%;justify-content: end; margin-right: 5px;">Nombre Padre:</label>
                 <input type="text" class="form-control" style="width:67%;" id="nombrePadre" value="{{$alumno->alu_nombre_padre}}">
                 <span class="text-danger" style="width:100%;margin-right:25%;font-size:11px;"></span>
             </div>
        </div>
        <div class="row" style="margin-top:5px;">
...
<script src="{{ URL::asset('js/alumnos/edit.js'); }}"></script>     
@stop